...
local useProgression = false
local progressionCard = nil
local useAspect = 2
local aspect = nil

local Raycast = require("Raycast")

-- luacheck: globals onLoad
function onLoad()
...
local function HandleAspect(deck, player_color)
    if useAspect == 0 then
        deck.destruct()
...
-- luacheck: globals ToggleProgression
