...
posMap = { -- This order should exactly match alternateSetupNames table
    ...
    { -- 6 Player
        ...
        { -- Star
            Vector(11.99, 0.00, 14.92),
            Vector(26.48, 0.00, 21.57),
            Vector(10.50, 0.00, -0.93),
            Vector(39.48, 0.00, 12.30),
            Vector(23.57, 0.00, -10.17),
            Vector(37.97, 0.00, -3.46),
        },
        { -- Flower
            Vector(9.93, 0.00, 22.51),
            Vector(17.58, 0.00, 5.95),
            Vector(32.03, 0.00, 12.73),
            Vector(50.17, 0.00, 11.14),
            Vector(30.71, 0.00, -3.14),
            Vector(20.21, 0.00, -18.04),
        },
        { -- Caldera
